      ...
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="dropdown text-end">
          <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="images/user.jpg" alt="User Image" width="32" height="32" class="rounded-circle">
          </a>
...
<script>
  $(document).ready(function () {
    ...
    // Add a change event listener to the "Yes" checkbox
    $('#checkYes').change(function () {
      // Enable the "Agree" button if "Yes" is checked, disable otherwise
